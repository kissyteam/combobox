...
var ComboboxTpl = require('./xtpl/tpl-render');
...
ComboBox = Control.extend({
    ...
    ATTRS: {
         ...
         * @cfg {Menu.PopupMenu|Object} menu
         */
        /**
         * ComboBox dropDown menuList or config
         * @property menu
         ...
         * @cfg {ComboBox.LocalDataSource|ComboBox.RemoteDataSource|Object} dataSource
         */
        /**
         * @ignore
         */
